...
本文四项为工作包，按[工作项队列](2026-09-05-work-item-sequence.md#2-pilot-1先完整治理再测价值)细化为任务卡。技术负责人先冻结知识版本/来源发布权限/受众和发送边界契约，再按[交付规范](../worker-delivery-protocol.md)分派；模型或 worker 不能自行选择撤回语义或接受外发竞态风险。
